...
class NextMatchFragment:Fragment(), AnkoComponent<Context>, ScheduleMatchView {
    lateinit var swipeRefresh: SwipeRefreshLayout
    private lateinit var listMatch: RecyclerView
    private lateinit var progressBar: ProgressBar

    var scheduleNextMatch: MutableList<Schedules> = mutableListOf()
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        adapter = ScheduleMatchAdapter(ctx, scheduleNextMatch) {
    ...
    override fun showSchedule(data: List<Schedules>) {
        ...
        scheduleNextMatch.clear()
        scheduleNextMatch.addAll(data)
